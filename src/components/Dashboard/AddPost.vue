  ...
  <div class="dashboard_form">
    ...
    <form @submit.prevent="submitHandler">
        ...
        >
            ...
            <p class="error_label" v-if="!$v.formdata.desc.maxLength">
                Must not be greather than {{$v.formdata.desc.$params.maxLength.max}} characters
            </p>
    ...
    <md-dialog :md-active="dialog">
      ...
      <md-dialog-actions>
        ...
        <md-button class="md-primary" @click="dialogOnCancel">Ops, I want to add it</md-button>
